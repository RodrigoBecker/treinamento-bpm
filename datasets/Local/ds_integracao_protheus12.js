...
function getObjectFactory(serviceHelper) {
	var objectFactory = serviceHelper.instantiate("spon010108647._8033.ObjectFactory");
...
function data() {
	return {
  "fluigService" : "PRODUTOS PROTHEUS V12",
  "operation" : "getMATA010",
  "soapService" : "WSPRODUTOS",
  "portType" : "WSPRODUTOSSOAP",
  "locatorClass" : "spon010108647._8033.WSPRODUTOS",
